        ...
        fallback={
          <Sheet open={openMobile()} onOpenChange={setOpenMobile} {...rest}>
            ...
            >
              ...
              <div className="flex h-full w-full flex-col">{local.children}</div>
            </SheetContent>
          </Sheet>
        }
      >
...
function SidebarTrigger(props: ComponentProps<typeof Button>) {
  const [local, rest] = splitProps(props, ['className', 'onClick'])
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn('size-7', local.className)}
      onClick={(event) => {
...
function SidebarInput(props: ComponentProps<typeof Input>) {
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn('h-8 w-full bg-background shadow-none', local.className)}
      {...rest}
    />
  )
}
...
function SidebarHeader(props: ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-sidebar="header"
      className={cn('flex flex-col gap-2 p-2', local.className)}
      {...rest}
    />
  )
}
...
function SidebarSeparator(props: ComponentProps<typeof Separator>) {
  ...
  return (
    <Separator
      ...
      className={cn('mx-2 w-auto bg-sidebar-border', local.className)}
      {...rest}
    />
  )
}
...
function SidebarGroup(props: ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-sidebar="group"
      className={cn('relative flex w-full min-w-0 flex-col p-2', local.className)}
      {...rest}
    />
  )
}
...
function SidebarGroupContent(props: ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      className={cn('w-full text-sm', local.className)}
      {...rest}
    />
  )
}
...
function SidebarMenu(props: ComponentProps<'ul'>) {
  ...
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn('flex w-full min-w-0 flex-col gap-1', local.className)}
      {...rest}
    />
  )
}
...
function SidebarMenuItem(props: ComponentProps<'li'>) {
  ...
  return (
    <li
      ...
      className={cn('group/menu-item relative', local.className)}
      {...rest}
    />
  )
}
...
function SidebarMenuButton(
  ...
  const [local, rest] = splitProps(props, ['isActive', 'variant', 'size', 'className'])
  return (
    <button
      type="button"
...
function SidebarMenuAction(
  ...
  const [local, rest] = splitProps(props, ['className', 'showOnHover'])
  return (
    <button
      type="button"
...
function SidebarMenuSkeleton(
  ...
  const [local, rest] = splitProps(props, ['className', 'showIcon'])
  const width = createMemo(() => `${Math.floor(Math.random() * 40) + 50}%`)
  return (
    <div
      data-slot="sidebar-menu-skeleton"
      data-sidebar="menu-skeleton"
      className={cn('flex h-8 items-center gap-2 rounded-md px-2', local.className)}
      {...rest}
    >
...
function SidebarMenuSubItem(props: ComponentProps<'li'>) {
  ...
  return (
    <li
      ...
      className={cn('group/menu-sub-item relative', local.className)}
      {...rest}
    />
  )
}
...
function SidebarMenuSubButton(
  ...
  const [local, rest] = splitProps(props, ['size', 'isActive', 'className'])
  return (
    <a
      ...
      className={cn(
        ...
        (local.size ?? 'md') === 'sm' && 'text-xs',
        (local.size ?? 'md') === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        local.className
      )}
      {...rest}
