...
vi.mock('@/components/HistoryPanel/HistoryHeader', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/components/HistoryPanel/HistoryHeader')>()
  return {
