      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-1 max-[650px]:grid-cols-1">
        {items.map((item) => (
          <button
            ...
            className="grid h-16 min-w-0 grid-cols-[2.5rem_minmax(0,1fr)_auto] items-center gap-3 rounded-md px-2.5 text-left text-foreground outline-none hover:bg-accent disabled:opacity-42 data-[active=true]:bg-accent data-[active=true]:shadow-[inset_0_0_0_1px_rgb(124_140_255/48%)]"
