...
function browserAssetHeaders(
  ...
  return {
    ...
    "content-security-policy": `default-src 'self'; base-uri 'none'; connect-src 'self' ws://${webSocketHost}:* https://api.github.com; form-action 'none'; frame-ancestors 'none'; img-src 'self' data: https://avatars.githubusercontent.com; object-src 'none'; script-src 'self'; style-src 'self' 'unsafe-inline'`,
